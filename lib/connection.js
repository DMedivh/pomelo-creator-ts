...
class ConnectionBase extends eventemitter3_1.EventEmitter {
    ...
    async connect(opts = {}) {
        ...
        exports.handshakeBuffer.user = opts.user || {};
        ...
        exports.handshakeBuffer.sys.protoVersion = this.protoVersion;
        this.once('handshake', () => {
            this.send(protocol_1.Package.encode(protocol_1.PackageType.TYPE_HANDSHAKE, protocol_1.strencode(JSON.stringify(exports.handshakeBuffer))));
        });
    }
    /**
        ...
        for (let i in msgs) {
            ...
            switch (msg.type) {
                ...
                case protocol_1.PackageType.TYPE_KICK:
                    {
                        console.warn("服务器主动断开连接", JSON.parse(protocol_1.strdecode(msg.body)));
