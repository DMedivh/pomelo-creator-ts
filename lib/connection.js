...
class ConnectionBase extends eventemitter3_1.EventEmitter {
    ...
    defaultEncode(reqId, route, msg = {}) {
        ...
        return protocol_1.Message.encode(reqId, reqId ? protocol_1.MessageType.TYPE_REQUEST : protocol_1.MessageType.TYPE_NOTIFY, this.dict[route], this.dict[route], msg, false);
    }
    defaultDecode(data) {
